...
from utils.log import timeLable, readSettings, saveMCTSRes  # , VisualizeInterMCTS, VisualizeMCTS
...
class Node:
    ...
    def checkExpand(self):
        """
            node status: 1 terminal; 2 too long; 3 legal leaf node; 4 legal no-leaf node
        """
        if self.path[-1] == '$':
            return 1
