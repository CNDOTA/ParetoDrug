...
class MFT(nn.Module):
    ...
    def __init__(self, d_model=512, nhead=4, num_layers=4, dim_feedforward=1024, pro_voc_len=10, smi_voc_len=10, proPaddingIdx=0, smiPaddingIdx=0, smiMaxLen=1, proMaxLen=1, **kwargs):
